...
//! - 91% person recall on real engram thoughts
...
//! "TCGplayer" or "Engram Inc" don't get pulled into `person`
...
pub fn extract_ner(content: &str, gliner: &GLiNER<SpanMode>) -> Result<NerOutput, TaggerError> {
    ...
    // equivalent for the engram-corpus failure modes (Claude ⊆ Claude

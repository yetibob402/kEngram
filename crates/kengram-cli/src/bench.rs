//! `kengram bench rerank` — A/B benchmarking harness comparing RRF-only
...
use anyhow::Context;
use kengram_core::{Embedder, Scope, ScopeError, ndcg_at_k, reciprocal_rank};
use kengram_embed::Reranker;
use kengram_mcp::{SearchRequest, search};
    ...
    fn corpus_parses_valid_fixture() {
        let json = r#"{
            "queries": [
                ...
                {
                    "query": "what does Kengram use as a vector store",

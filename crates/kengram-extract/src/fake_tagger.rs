...
use kengram_core::{ScopeVocab, TagOutput, Tagger, TaggerError, Tags};
...
/// mode. Mirrors `FakeScoring` in kengram-embed: composable, predictable
...
mod tests {
    use super::*;
    use kengram_core::{ExtractedRelation, ExtractedTarget, RelationKind, TagKind};
